...
for objname in allDisplayPoints:
    allDisplayPoints[objname]['value'] = byobjname[objname]['presentValue']
    if 'units' in byobjname[objname]:
        allDisplayPoints[objname]['units'] = byobjname[objname]['units']
...
print(json.dump(allOutputPoints,open(CACHE_STAGE,"w"),indent=4))
